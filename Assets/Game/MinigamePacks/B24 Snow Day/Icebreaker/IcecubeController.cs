...
public class IcecubeController : MonoBehaviour
{
    ...
    void Update()
    {
        if (stability > 0) {
            if (
                ((neighborUp == null || neighborUp.stability > 0) && (neighborDown == null || neighborDown.stability > 0)) ||
                ((neighborLeft == null || neighborLeft.stability > 0) && (neighborRight == null || neighborRight.stability > 0))
            ) {
    ...
    public void Smash()
    {
        if (stability > 0) {
            stability--;
            AudioSource source = GetComponent<SoundEffectController>().GetSource(stability == 0 ? "Crack" : "Shatter");  
